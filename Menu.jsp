...
<body>
    ...
    <div class="menu-container">
        ...
        <div class="menu-item">
            ...
            <p>Delicious butter chicken served with naan.</p>
            <p>Price: $13.99</p>
            <button class="add-to-cart" data-name="Chicken Biriyani" data-price="12.99">Add to Cart</button>
        </div>
        
        
        <!-- Add more North Indian items here -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addToCartButtons.forEach(button => {
            button.addEventListener('click', function(event) {
                const itemName = button.getAttribute('data-name'); // Assuming data-name attribute exists
                const itemPrice = button.getAttribute('data-price'); // Assuming data-price attribute exists
